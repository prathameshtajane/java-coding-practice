 ...
 * Example 1:
 ...
 DP problem : Maximum Sum Subsequence Non-Adjacent
 Link : https://leetcode.com/problems/house-robber/description/
 Youtube Link : https://www.youtube.com/watch?v=UtGtF6nc35g
 *
 */
public class HouseRobber {
    public int rob(int[] nums) {
        ...
        for(int i = 1;i<nums.length;i++){
            ...
            exclusive=temp_inclusive;
        }
        return inclusive;
    }
    public static void main(String args[]){
        System.out.println("House Owner Started !");
        int[] input = {1,2,3,1};
